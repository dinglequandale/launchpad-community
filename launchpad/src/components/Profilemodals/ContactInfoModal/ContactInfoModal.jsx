  ...
  return (
    <div>
      ...
      >
        ...
        <header>
          <h2 style={{margin: "0 auto", textAlign: "center", paddingBottom: "5px", color: "var(--secondary)"}}> Contact Information <br /> <span style={{fontWeight: "250", fontSize: "smaller"}}>Connect with the School Network</span></h2>
