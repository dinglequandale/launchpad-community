        ...
        <>
            <article className="iconContainer">
                ...
                <div style={{display: "flex", flexDirection: "column", lineHeight: "1.2", justifyContent: "left"}}>
                    ...
                    <button className="btnText diff-color" onClick={()=>navigate("/profile", { state: {pathName : window.location.pathname }})} style={{width: "fit-content", fontSize: "18px"}}>My Profile</button>
                </div>
            </article>
        </>
    )
