...
export default function SaveChanges({visibility, onCancel, onVerify}){
    const customStyles = {
        content: {
          top: '50%',
          left: '50%',
    ...
    return(
        ...
        >
          <main style={{textAlign: "center"}}>
            <span style={{fontWeight: "600", color: "var(--secondary)", fontSize: "40px"}}>Would you like</span>
            <hr style={{width: "70%", borderColor: "var(--accent)", borderWidth: "2px"}}/>
            <span style={{fontSize: "larger", paddingTop: "10px"}}>to save your changes?</span>
          </main>
