...
export default function OrganizationProfile({organizationData}){
    ...
    const organizationType = "Community Service";
    const iconApplicability = true;
    const bannerApplicability = true;
    const relevance = [["finance", "business fields"], organizationType];
    return(
        <div className="organizationProfileContainer" style={{position: "relative"}}>
            {bannerApplicability && <RelevanceBanner relevanceType={relevance}/>}
            <div style={{width: "75%", borderRightStyle: "solid", borderRightColor: "#C0C0C0", borderWidth: "1.5px", overflow: "hidden"}}>
                <div style={{display: "flex", position: "relative", justifyContent: "center", alignItems: "center"}}>
                    ...
                    <div style={{paddingLeft: "15px"}}>
                        <span style={{fontWeight: "bolder", fontSize: "20px"}}>Organization Name </span> <br />
                ...
                {iconApplicability && <div style={{display: "flex", justifyContent: "space-evenly", paddingTop: "10px"}}>
            ...
            <div style={{display: "flex", justifyContent: "center", alignItems: "center", width: "25%", flexDirection: "column", gap: "20px"}}>
                ...
                <button className="btnOrganizationLearnMore"> {organizationType==="Community Service" ? "Volunteer" : "Connect"} </button>
            </div>
        </div>
    )
}
...
function RelevanceBanner({relevanceType}){
    return(
        <div style={{borderRadius: "20px", position: "absolute", top: "-10px", left: "10px", width: "fitContent", padding: "4px 8px", background: "rgb(47,162,52)",
